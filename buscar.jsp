...
%>
<%
AuxTitulo=request.getParameter("titulo_B");
Auxautor=request.getParameter("autor_B");
    //proceso
    //--abre conexión
    ...
    if (!conexion.isClosed()){
        ...
        WHERE (((titulo=" +AuxTitulo+") AND (autor="+Auxautor+")) OR (autor="+Auxautor+") OR (titulo="+titulo+"); ");
        //formato JSON
        out.println("{");
        out.println("   \"listado\":");
        out.println("       [");
